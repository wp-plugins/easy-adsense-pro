...
$myPlugins['adsense-now'] =
  array('value' => 'AdSense Now!',
    ...
    'pro' => 'The Lite version of AdSense Now! is fully functional. However, it has an ad slot sharing mechanism built in whereby you can donate about 5% of your ad spaces to the author of the plugin. It may also put a small powered-by kind of link below the first ad block on your pages. The Pro version has these options turned off and gives you options on the admin page to control them.',
    'title' => 'AdSense Now! is the simplest possible way to generate revenue from your blog using Google AdSense. Aiming at simplicity, AdSense Now! does only one thing: it puts your AdSense code in up to three spots in your posts and pages (both existing ones and those yet to be written).') ;
...
$myPlugins['theme-tweaker'] =
  array('value' => 'Theme Tweaker',
    ...
    'pro' => 'Note that Theme Tweaker may not work with some themes. Please verify its suitability using the Lite version first. The Lite version of the plugin is fully functional. It puts a small powered-by kind of link at the bottom of your pages though. The Pro version gives you an option on the admin page to turn off the back link.',
    'title' => 'Theme Tweaker displays the existing colors from your current theme, and gives you a color picker to replace them. It also lets you change them in bulk, like invert all colors, use grey scale etc.') ;
...
$myPlugins['easy-translator'] =
  array('value' => 'Easy Translator',
    ...
    'title' => 'Easy Translator is a plugin to translate other plugins. It picks up translatable strings (in _[_e]() functions) and presents them and their existing translations (from the MO object of the current text-domain, if loaded) in a user editable form. It can generate a valid PO file that can be emailed to the plugin author directly from the its window, streamlining your work.') ;
